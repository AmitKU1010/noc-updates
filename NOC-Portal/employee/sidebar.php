                ...
                <div class="d-flex order-lg-2 ml-auto">
                    ...
                    <div class="dropdown d-none d-md-flex country-selector">
                        <a href="#" class="d-flex nav-link leading-none">
                            <div>
                                <a href="<?php echo $url; ?>employee/create-request.php" class="btn btn-primary">
                                    <i class="fa fa-plus"></i> Create Request
                                </a>
                            </div>
                        </a>
                    ...
                    <div class="dropdown d-none d-md-flex">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            <a href="<?php echo $url; ?>employee/pending-request.php" class="dropdown-item d-flex pb-3">
                                <div class="notifyimg">
                                    <i class="fa fa-refresh"></i>
                                </div>

                                <div>
                                    <strong>Re-check Comment</strong>
                                    <div class="small text-muted">04:50 Pm</div>
                                </div>
                            </a>

                            <a href="<?php echo $url; ?>employee/approved-request.php" class="dropdown-item d-flex pb-3">
                                <div class="notifyimg">
                                    <i class="fa fa-certificate"></i>
                                </div>

                                <div>
                                    <strong>Your Request Approved!</strong>
                    ...
                    <div class="dropdown ">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
                            <a class="dropdown-item" href="<?php echo $url; ?>employee/profile.php">
    ...
    <aside class="app-sidebar doc-sidebar">
        ...
        <ul class="side-menu">
            <li class="slide">
                <a class="side-menu__item" href="<?php echo $url; ?>employee/index.php">
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo $url; ?>employee/create-request.php">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li>
                        <a href="<?php echo $url; ?>employee/pending-request.php" class="slide-item">Pending Request</a>
                    </li>

                    <li>
                        <a href="<?php echo $url; ?>employee/recheck-request.php" class="slide-item">Re-check Request</a>
                    </li>

                    <li>
                        <a href="<?php echo $url; ?>employee/approved-request.php" class="slide-item">Approved Request</a>
                    </li>
                </ul>
            </li>
        </ul>
