<?php 
    ...
    $title = 'Re-check Request | NOC App';
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
										<?php 
											...
											$sql = "SELECT * FROM tracker INNER JOIN request on tracker.req_id = request.req_id WHERE tracker.hod_id = $user_id AND tracker.recheck = '1'";
												...
												<tbody>
                                                    ...
                                                    ?>
														...
														<tr class="text-center">
															...
															<td>
																<a href="#" class="btn btn-primary btn-sm mb-2" data-toggle="modal" data-target="#viewRequest" title="View">
						...
						<form action="pending-request.php" method="post">
							...
							<div class="modal-body pd-20">
								<div class="form-group">
									...
									<textarea class="form-control" name="comments" rows="4" placeholder="Description..."></textarea>
								</div>
							</div><!-- modal-body -->
